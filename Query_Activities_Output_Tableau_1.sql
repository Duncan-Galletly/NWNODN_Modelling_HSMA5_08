...
SELECT @SolutionColumns = STUFF((SELECT ', ' + QUOTENAME(COLUMN_NAME)
...
SELECT @SelectSolutionNumbers = STUFF((SELECT ', '''+ RIGHT(COLUMN_NAME, LEN(COLUMN_NAME) - CHARINDEX('_', COLUMN_NAME)) + ''' AS ' + QUOTENAME(COLUMN_NAME + '_Number')
    FROM INFORMATION_SCHEMA.COLUMNS
    WHERE TABLE_SCHEMA = 'dbo'
    AND TABLE_NAME = 'NICU_Modelling_Activities_Output'
...
Select Solution,
		...
		CC_Level,
		Count(*),
		Case when CC_Activity_Date between ''2018-03-31'' and ''2019-04-01''
				then ''18/19''
			 when CC_Activity_Date between ''2019-03-31'' and ''2020-04-01''
				then ''19/20''
			 when CC_Activity_Date between ''2020-03-31'' and ''2021-04-01''
				then ''20/21''
			 when CC_Activity_Date between ''2021-03-31'' and ''2022-04-01''
				then ''21/22''
			 end as Fin_Year
		From (
